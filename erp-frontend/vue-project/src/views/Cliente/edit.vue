    ...
    <div class="container mt-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <button type="button" @click="updateCliente" class="btn btn-primary">Gravar</button>
                </div>
            </div>
        </div>
    </div>
...
export default{
    ...
    methods: {
        ...
        updateCliente(){
            ...
            axios.patch(`http://localhost:8000/cliente/${this.clienteCodigo}`, this.model.cliente).then(res=>{
